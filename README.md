...
Go to SysEx configurator: https://c0ff.github.io/TRAM8-4x4/tram8_4x4_fw5.html
...
## Features:
 ...
 - Gate/Trigger sources: Note On, MIDI Clock divider, RUN gate, Reset trigger
 - Gate output from a Clock divider works as a flip-flop (square LFO)
 - Global Clock Divider Scale. Allows to set clock dividers in multiples of MIDI pulses.
 ...
 - Global option to reset clock dividers on MIDI Continue command (enabled by default)
...
## To use:
 - Download and open locally `FW-4x4 HTML FILES/tram8_4x4_fw5.html`
 - Edit the settings to your liking and get the `tram8_4x4_fw5_edit.syx`
 - Send the generated .syx file to your Tram8 module in the update mode
 - Enjoy!
...
### Global:
 ...
 - Clock Divider Scale: 1/4 note (1 ppqn)
...
### Gates:
 ...
 5. Trigger on quarter notes (24 MIDI pulses) // beat clock
 6. Trigger on each 4/4 bar (4x24 MIDI pulses) // bar clock in 4/4
